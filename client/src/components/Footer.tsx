    ...
    <>
      <footer className="mt-32 px-6 md:px-16 lg:px-24 xl:px-32 w-full text-sm text-slate-500 bg-white pt-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-14">
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <p className="text-sm/7 mt-6">
              Filperan is socail medai marketplace. We are the leading socail
              media marketpalce that connects brands with thier customers with
        ...
        <p className="py-4 text-center border-t mt-6 border-slate-200">
          Copyright 2025 © FullStack.dev All Right Reserved.
        </p>
      </footer>
    </>
  );
